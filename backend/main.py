...
app = FastAPI(
    title="AI Engineer Portfolio API",
    description="Backend API for AI Engineer Portfolio",
    version="1.0.0"
)
...
async def contact_message(message: ContactMessage):
    ...
    try:
        ...
        logger.info(f"Received contact message from {message.name} ({message.email})")
